...
namespace SystemInformation
{
	...
	public class HolidayCalculator
	{
		...
		void ProcessXML()
		{
			var xmlNodeList = xHolidays.SelectNodes("/Holidays/Holiday");
			if (xmlNodeList != null)
		...
		{
			var h = new Holiday {HolidayName = n.Attributes["name"].Value};
			var childNodes = new ArrayList();
			...
			{
				var selectSingleNode = n.SelectSingleNode("./Month");
				if (selectSingleNode != null)
				{
					int m = Int32.Parse(selectSingleNode.InnerXml);
					var singleNode = n.SelectSingleNode("./WeekOfMonth");
					if (singleNode != null)
					{
						int w = Int32.Parse(singleNode.InnerXml);
						var xmlNode = n.SelectSingleNode("./DayOfWeek");
						if (xmlNode != null)
						{
			...
			{
				var selectSingleNode = n.SelectSingleNode("./DayOfWeekOnOrAfter/DayOfWeek");
				if (selectSingleNode != null)
				{
					...
					var singleNode = n.SelectSingleNode("./DayOfWeekOnOrAfter/Month");
					if (singleNode != null)
					{
						int m = Int32.Parse(singleNode.InnerXml);
						var xmlNode = n.SelectSingleNode("./DayOfWeekOnOrAfter/Day");
						if (xmlNode != null)
						{
			...
			{
				var selectSingleNode = n.SelectSingleNode("./WeekdayOnOrAfter/Month");
				if (selectSingleNode != null)
				{
					int m = Int32.Parse(selectSingleNode.InnerXml);
					var singleNode = n.SelectSingleNode("./WeekdayOnOrAfter/Day");
					if (singleNode != null)
					{

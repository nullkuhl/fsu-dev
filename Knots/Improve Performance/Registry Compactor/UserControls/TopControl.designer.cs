...
namespace RegistryCompactor
{
	partial class TopControl
	{
		...
		/// </summary>
		/// <param name="disposing">true if managed resources should be isDisposed; otherwise, false.</param>
		...
		void InitializeComponent()
		{
            ...
            this.lblHelp.Image = global::RegistryCompactor.Properties.Resources.help_off;
            ...
            this.lblIcon.Image = global::RegistryCompactor.Properties.Resources.icon_registry_compactor;
		...
		Label lblBar;
		TableLayoutPanel tlpTop;
		TableLayoutPanel tlpRight;
		Label lblText;
		Label lblHelp;
		Label lblIcon;
	}

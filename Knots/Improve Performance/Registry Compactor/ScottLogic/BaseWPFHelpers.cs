...
namespace BaseWPFHelpers
{
	...
	public class Helpers
	{
		...
		#region Nested type: FinderMatchFocused
		...
		{
			#region IFinderMatchVisualHelper Members

			/// <summary>
			/// Checks if the <paramref name="item"/> is focused
			/// </summary>
		...
		#region Nested type: FinderMatchItemHost
		...
		public class FinderMatchItemHost : IFinderMatchVisualHelper
		{
			...
			/// <summary>
			/// Checks if the <paramref name="item"/> is item host
			/// </summary>
			/// <param name="item"></param>
			/// <returns></returns>
			public bool DoesMatch(DependencyObject item)
		...
		#region Nested type: FinderMatchName
		...
		public class FinderMatchName : IFinderMatchVisualHelper
		{
			...
			/// <summary>
			/// Checks if the <paramref name="item"/>.Name equals to the <c>_name</c> property
			/// </summary>
			/// <param name="item"></param>
			/// <returns></returns>
			public bool DoesMatch(DependencyObject item)
		...
		#region Nested type: FinderMatchType
		...
		#region Nested type: IFinderMatchVisualHelper

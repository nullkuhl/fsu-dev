...
namespace ScottLogic.Shapes
{
    ...
    class PiePiece : Shape
    {
		...
		/// <summary>
		/// PushOut <c>DependencyProperty</c>
		/// </summary>
		...
		/// <summary>
		/// Inner radius DependencyProperty
		/// </summary>
		...
		/// <summary>
		/// Wedge angle DependencyProperty
		/// </summary>
		...
		/// <summary>
		/// Rotation angle <c>DependencyProperty</c>
		/// </summary>
		...
		/// <summary>
		/// CentreX <c>DependencyProperty</c>
		/// </summary>
		...
		/// <summary>
		/// CentreY <c>DependencyProperty</c>
		/// </summary>
		...
		/// <summary>
		/// Percentage <c>DependencyProperty</c>
		/// </summary>
		...
		/// <summary>
		/// Piece value <c>DependencyProperty</c>
		/// </summary>

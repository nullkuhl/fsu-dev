...
/*
	  ...
	  //  static extern int SHGetSpecialFolderLocation(IntPtr hwndOwner, eFlags nFolder, ref IntPtr ppidl);
	 ...
	 //   static extern bool GetVersionEx(ref OSVERSIONINFO osvi);  
		...
		string ExtractName(string sFile)
		{
			int lLen = 0;
			char[] ch;
			string path = sFile;
		...
		string PathFilter(string sPath)
		{
			string path = sPath;

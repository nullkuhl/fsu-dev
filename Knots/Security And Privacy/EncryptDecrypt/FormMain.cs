	...
	public partial class frmMain : Form
	{
		...
		bool PatchDecrypter(string srcpath, string encpath, string password)
		{
            try
            {
                ...
                //  var decrypterPath = new Uri(new Uri(execPath), "Decrypter.exe").LocalPath;
		...
		{
			var fd = new FolderBrowserDialog { Description = rm.GetString("select_folder_encrypt") + "." };
			fd.ShowDialog();
			if (fd.SelectedPath != "")
			{

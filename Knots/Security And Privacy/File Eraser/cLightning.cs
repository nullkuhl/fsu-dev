...
namespace FileEraser
{
	...
	public class cLightning
	{
		...
		static extern int AdjustTokenPrivileges(IntPtr TokenHandle, int DisableAllPriv, ref TOKEN_PRIVILEGES NewState,
		...
		static extern int LookupPrivilegeValue(int lpSystemName, [MarshalAs(UnmanagedType.LPWStr)] string lpName,
		                                       ref LUID lpLuid);

		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "LookupPrivilegeValueA", SetLastError = true)]
		static extern int LookupPrivilegeValueA(int lpSystemName, [MarshalAs(UnmanagedType.LPStr)] string lpName,
		                                        ref LUID lpLuid);

		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "OpenProcessToken", SetLastError = true)]
		static extern int OpenProcessToken(IntPtr ProcessHandle, uint DesiredAccess, ref IntPtr TokenHandle);
		...
		static extern int RegQueryValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int lpReserved,
		                                  out uint lpType, [Optional] StringBuilder lpData, ref uint lpcbData);

		[DllImport("advapi32.dll", CharSet = CharSet.Ansi, EntryPoint = "RegQueryValueExA", SetLastError = true)]
		static extern int RegQueryValueExA(UIntPtr hKey, [MarshalAs(UnmanagedType.LPStr)] string lpValueName, int lpReserved,
		                                   out uint lpType, [Optional] [MarshalAs(UnmanagedType.LPStr)] string lpData,
		                                   ref uint lpcbData);

		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegQueryValueExW", SetLastError = true)]
		static extern int RegQueryValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int lpReserved,
		                                  ref uint lpType, [Optional] ref byte lpData, ref uint lpcbData);
		...
		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegQueryValueExW", SetLastError = true)]
		static extern int RegQueryValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int lpReserved,
		                                  ref uint lpType, [Optional] ref int lpData, ref uint lpcbData);
		...
		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegQueryValueExW", SetLastError = true)]
		static extern int RegQueryValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int lpReserved,
		                                  ref uint lpType, [Optional] ref long lpData, ref uint lpcbData);
		...
		static extern int RegSetValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int Reserved,
		                                uint dwType, ref int lpData, int cbData);

		[DllImport("advapi32.dll", CharSet = CharSet.Ansi, EntryPoint = "RegSetValueExA", SetLastError = true)]
		static extern int RegSetValueExA(UIntPtr hKey, [MarshalAs(UnmanagedType.LPStr)] string lpValueName, int Reserved,
		                                 uint dwType, ref int lpData, int cbData);

		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegSetValueExW", SetLastError = true)]
		static extern int RegSetValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int Reserved,
		                                uint dwType, ref long lpData, int cbData);
		...
		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegSetValueExW", SetLastError = true)]
		static extern int RegSetValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int Reserved,
		                                uint dwType, IntPtr lpData, int cbData);

		[DllImport("advapi32.dll", CharSet = CharSet.Ansi, EntryPoint = "RegSetValueEA", SetLastError = true)]
		static extern int RegSetValueExA(UIntPtr hKey, [MarshalAs(UnmanagedType.LPStr)] string lpValueName, int Reserved,
		                                 uint dwType, [MarshalAs(UnmanagedType.LPStr)] string lpData, int cbData);

		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegSetValueExW", SetLastError = true)]
		static extern int RegSetValueEx(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName, int Reserved,
		                                uint dwType, ref byte lpData, int cbData);
		...
		static extern int RegOpenKeyEx(ROOT_KEY hKey, [MarshalAs(UnmanagedType.LPWStr)] string subKey, int options,
		                               int samDesired, ref UIntPtr phkResult);

		[DllImport("advapi32.dll", CharSet = CharSet.Ansi, EntryPoint = "RegOpenKeyExA", SetLastError = true)]
		static extern int RegOpenKeyExA(ROOT_KEY hKey, [MarshalAs(UnmanagedType.LPStr)] string subKey, int options,
		                                int samDesired, ref UIntPtr phkResult);
		...
		static extern int RegDeleteValue(UIntPtr hKey, [MarshalAs(UnmanagedType.LPWStr)] string lpValueName);
		...
		static extern int RegCreateKeyEx(ROOT_KEY hKey, [MarshalAs(UnmanagedType.LPWStr)] string subKey, int Reserved,
		                                 [MarshalAs(UnmanagedType.LPWStr)] string lpClass, int dwOptions, int samDesired,
		                                 ref SECURITY_ATTRIBUTES lpSecurityAttributes, ref UIntPtr phkResult,
		                                 ref int lpdwDisposition);

		[DllImport("advapi32.dll", CharSet = CharSet.Ansi, EntryPoint = "RegCreateKeyExA", SetLastError = true)]
		static extern int RegCreateKeyExA(ROOT_KEY hKey, [MarshalAs(UnmanagedType.LPStr)] string subKey, int Reserved,
		                                  [MarshalAs(UnmanagedType.LPStr)] string lpClass, int dwOptions, int samDesired,
		                                  ref SECURITY_ATTRIBUTES lpSecurityAttributes, ref UIntPtr phkResult,
		                                  ref int lpdwDisposition);

		[DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "RegEnumKeyExW", SetLastError = true)]
		static extern int RegEnumKeyEx(UIntPtr hKey, uint index, StringBuilder lpName, ref uint lpcbName, IntPtr reserved,
		...
		static extern int RegEnumKeyExA(UIntPtr hKey, uint index, [MarshalAs(UnmanagedType.LPStr)] string lpName,
		...
		static extern int RegEnumValue(UIntPtr hKey, uint dwIndex, StringBuilder lpValueName, ref uint lpcValueName,
		...
		static extern int RegEnumValueA(UIntPtr hKey, uint dwIndex, [MarshalAs(UnmanagedType.LPStr)] string lpValueName,
		                                ref uint lpcValueName, IntPtr lpReserved, IntPtr lpType, IntPtr lpData,
		                                IntPtr lpcbData);
		...
		public bool AccessTest(ROOT_KEY RootKey, string SubKey)
		{
			...
			int lDeposit = 0;
			var tSecAttrib = new SECURITY_ATTRIBUTES();
		...
		public bool EnableAccess(bool Enable)
		{
			...
			var uPriv =
				(uint)
				(ETOKEN_PRIVILEGES.TOKEN_ADJUST_PRIVILEGES | ETOKEN_PRIVILEGES.TOKEN_QUERY | ETOKEN_PRIVILEGES.TOKEN_QUERY_SOURCE);
		...
		public int ReadBigEndian(ROOT_KEY RootKey, string SubKey, string Value)
		{
			...
			uint pvSize = 4;
			var pdwType = (uint) VALUE_TYPE.REG_DWORD_BIG_ENDIAN;
			int pvData = 0;
		...
		public string ReadBinary(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 1024;
			var pdwType = (uint) VALUE_TYPE.REG_BINARY;
			var bBuffer = new byte[1024];
		...
		public int ReadDword(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 4;
			var pdwType = (uint) VALUE_TYPE.REG_DWORD;
			int pvData = 0;
		...
		{
			UIntPtr hKey = UIntPtr.Zero;
			var pvData = new StringBuilder(0);
			uint pvSize = 0;
			var pdwType = (uint) VALUE_TYPE.REG_EXPAND_SZ;
			...
			try
			{
				if (RegOpenKeyEx(RootKey, SubKey, 0, KEY_ALL_ACCESS, ref hKey) == ERROR_NONE)
				{
					...
					{
						pvData = new StringBuilder((int) (pvSize/2));
		...
		public string ReadLink(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 1024;
			var pdwType = (uint) VALUE_TYPE.REG_LINK;
			var bBuffer = new byte[1024];
			string sRet = String.Empty;
		...
		public string ReadMulti(ROOT_KEY RootKey, string SubKey, string Value)
		{
			...
			var pvData = new StringBuilder(0);
			uint pvSize = 0;
			var pdwType = (uint) VALUE_TYPE.REG_MULTI_SZ;
		...
		public long ReadQword(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 8;
			var pdwType = (uint) VALUE_TYPE.REG_QWORD_LITTLE_ENDIAN;
			long pvData = 0;
		...
		public string ReadResourceDescriptor(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 1024;
			var pdwType = (uint) VALUE_TYPE.REG_FULL_RESOURCE_DESCRIPTOR;
			var bBuffer = new byte[1024];
			string sRet = String.Empty;
		...
		public string ReadResourceList(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 1024;
			var pdwType = (uint) VALUE_TYPE.REG_RESOURCE_LIST;
			var bBuffer = new byte[1024];
			string sRet = String.Empty;
		...
		public string ReadResourceRequirements(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 1024;
			var pdwType = (uint) VALUE_TYPE.REG_RESOURCE_REQUIREMENTS_LIST;
			var bBuffer = new byte[1024];
			string sRet = String.Empty;
		...
		public string ReadString(ROOT_KEY RootKey, string SubKey, string Value)
		{
			...
			var pvData = new StringBuilder(0);
			uint pvSize = 0;
			var pdwType = (uint) VALUE_TYPE.REG_SZ;
		...
		public bool ValueExists(ROOT_KEY RootKey, string SubKey, string Value)
		{
			UIntPtr hKey = UIntPtr.Zero;
			uint pvSize = 0;
			var pdwType = (uint) VALUE_TYPE.REG_NONE;
		...
		public ArrayList EnumKeys(ROOT_KEY RootKey, string SubKey)
		{
			...
			long lastWrite = 0;
			UIntPtr hKey = UIntPtr.Zero;
			var keyName = new StringBuilder(0);
		...
		public ArrayList EnumValues(ROOT_KEY RootKey, string SubKey)
		{
			...
			int ret = 0;
			UIntPtr hKey = UIntPtr.Zero;
			var valName = new StringBuilder(0);

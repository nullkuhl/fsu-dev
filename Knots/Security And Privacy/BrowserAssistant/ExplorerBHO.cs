...
namespace BrowserAssistant
{
	...
	public class ExplorerBHO
	{
		...
		public static List<ExplorerBHO> List()
		{
			...
			var result = new List<ExplorerBHO>();
		...
		public static void SaveChanges(IEnumerable<ExplorerBHO> bhos)
		{
			...
			{
				RegistryKey bhosKey = Registry.LocalMachine.OpenSubKey("Software").OpenSubKey("Microsoft").OpenSubKey("Windows")
		...
		{
			RegistryKey oldKey = parent.OpenSubKey(oldName);
			RegistryKey newKey = parent.CreateSubKey(newName);

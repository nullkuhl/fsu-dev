...
namespace FreemiumUtilities.StartupManager
{
	...
	public partial class FrmDetails : Form
	{
		...
		public FrmDetails(IEnumerable<ListViewItem> LstVwItemLst)
		{
			...
			foreach (var item in LstVwItemLst)
			{
				//this.listView.Items.Add(new ListViewItem() { Text = item.Text });
		...
		void frmDetails_Load(object sender, EventArgs e)
		{
			...
			//this.listView.Columns.Add("Name", -2, HorizontalAlignment.Center);
			//this.listView.Columns.Add("Location", -2, HorizontalAlignment.Center);
		}

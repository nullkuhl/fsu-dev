...
namespace FreemiumUtilities.Routine
{
    ...
    /// </summary>
    public sealed class TypeEqualsToVisibilityConverter : IValueConverter
    {
        ...
        /// <returns><c>Visibility.Visible</c> if <paramref name="value"/> type equals to the type of <see cref="TracksEraserApp"/></returns>

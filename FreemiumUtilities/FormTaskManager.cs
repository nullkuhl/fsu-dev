	...
	public partial class FormTaskManager : Form
	{
		...
		public void btnOK_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				Task task = service.FindTask("Freemium1ClickMaint");
				...
				{
					var dTrigger = new DailyTrigger {DaysInterval = (short) nudDays.Value};
				...
				else if (cmbSelectSchedule.SelectedIndex == (int) Schedule.Monthly)
				{
					...
					{
						var mdTrigger = new MonthlyDOWTrigger();
				...
				if (isNewTask)
					service.RootFolder.RegisterTaskDefinition(@"Freemium1ClickMaint", td);
				else
